...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Re-submit Return']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Re-submit Return']); ?>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="item-detail-row">
                ...
                <div class="item-detail-value"><?php echo e($return->item->name); ?></div>
            </div>

            <div class="item-detail-row">
                <div class="item-detail-label">Category:</div>
                <div class="item-detail-value"><?php echo e($return->item->category->name); ?></div>
            </div>

            <div class="item-detail-row">
                <div class="item-detail-label">Description:</div>
                <div class="item-detail-value"><?php echo e($return->item->description); ?></div>
            </div>

            <div class="item-detail-row">
                <div class="item-detail-label">Found at:</div>
                <div class="item-detail-value"><?php echo e($return->item->location); ?></div>
            </div>

            <div class="item-detail-row">
                <div class="item-detail-label">Date found:</div>
                <div class="item-detail-value"><?php echo e($return->item->date_reported->format('m/d/Y')); ?></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <form action="<?php echo e(route('return.update', $return->id)); ?>" method="POST" enctype="multipart/form-data" id="editReturnForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('contact_email', $return->contact_email)); ?>"
                            required
                        >
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="contact_number" 
                            name="contact_number" 
                            class="form-input <?php $__errorArgs = ['contact_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            value="<?php echo e(old('contact_number', $return->contact_number)); ?>"
                            required
                        >
...
unset($__errorArgs, $__bag); ?>" 
                    ...
                    ><?php echo e(old('additional_details', $return->additional_details)); ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <?php if($return->image): ?>
                        <div class="current-file">
                            ✓ Current proof file: <?php echo e(basename($return->image)); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Ian Derilo\Herd\lostnfound\resources\views/edit_return.blade.php ENDPATH**/ ?>