...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin-layout','data' => ['title' => 'Manage Returns']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Manage Returns')]); ?>
    <style>
        .page-title {
            font-size: 28px;
            font-weight: bold;
        ...
        <div class="tabs-container">
            <button class="tab-button active" onclick="filterByStatus('all')">All submissions (<?php echo e($allReturnsCount); ?>)</button>
            ...
            <table class="table">
                ...
                <tbody id="returnsTableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="return-row" data-status="<?php echo e($return->status); ?>" data-search="<?php echo e(strtolower($return->item->name . ' ' . $return->user->name)); ?>">
                            <td><?php echo e($return->item->name); ?></td>
                            <td><?php echo e($return->item->user->name); ?></td>
                            <td><?php echo e($return->user->name); ?></td>
                            <td><?php echo e($return->contact_email); ?></td>
                            <td><?php echo e($return->created_at->format('M d, Y')); ?></td>
                            <td>
                                <span class="status-badge status-<?php echo e($return->status); ?>">
                                    <?php echo e(ucfirst($return->status)); ?>

                                </span>
                            </td>
                            <td>
                                <button class="view-button" onclick="openReturnModal(<?php echo e($return->id); ?>)">View</button>
                            </td>
                        </tr>
    ...
    <script>
        ...
        let allReturnsData = <?php echo json_encode($returns, 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\Users\Ian Derilo\Herd\lostnfound\resources\views/admin/manage_returns.blade.php ENDPATH**/ ?>