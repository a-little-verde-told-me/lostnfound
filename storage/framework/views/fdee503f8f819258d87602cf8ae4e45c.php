    ...
    <div class="navbar">
        ...
        <?php if(Auth::check()): ?>
            ...
            <ul class="navbar-nav">
                ...
                <li><a href="<?php echo e(route('history.index')); ?>">My History</a></li>
            </ul>
            <div class="navbar-right">
                <div class="user-menu">
                    <a href="<?php echo e(route('profile')); ?>" class="user-avatar" title="View Profile"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></a>
                </div>
                        ...
                        <div class="history-card claim-card">
                            ...
                            <div class="history-info">
                                <div class="info-item">
                                    ...
                                    <div class="info-value"><?php echo e($item->item?->category?->name ?? '-'); ?></div>
                                </div>
                                <div class="info-item">
                                    <div class="info-label">Your Email</div>
                                    <div class="info-value"><?php echo e($item->contact_email); ?></div>
                                </div>
                                <div class="info-item">
                                    <div class="info-label">Your Phone</div>
                                    <div class="info-value"><?php echo e($item->contact_number); ?></div>
                                </div>
                                <div class="info-item">
                                    <div class="info-label">Item Location</div>
                                    <div class="info-value"><?php echo e($item->item?->location ?? '-'); ?></div>
                                </div>
                            </div>
                            ...
                            <?php if($item->status === 'approved'): ?>
                                <div class="claim-feedback approved">
                                    ...
                                    <div class="claim-feedback-text">
                                        Pick up your item at: <?php echo e($item->item?->location ?? 'Guard post, main entrance'); ?>
...
<?php /**PATH C:\Users\Ian Derilo\Herd\lostnfound\resources\views/user/my_history.blade.php ENDPATH**/ ?>