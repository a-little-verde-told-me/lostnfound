...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout','data' => ['title' => 'Claim an Item']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Claim an Item']); ?>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="item-detail-row">
                ...
                <div class="item-detail-value"><?php echo e($item->found_location ?? 'Not specified'); ?></div>
            </div>

            <div class="item-detail-row">
                <div class="item-detail-label">Surrender location:</div>
                <div class="item-detail-value"><?php echo e($item->surrender_location ?? 'Guard post, main entrance'); ?></div>
            </div>
...
<?php endif; ?>
        ...
        <div class="card">
            ...
            <form action="<?php echo e(route('claim.store')); ?>" method="POST" enctype="multipart/form-data" id="claimForm">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        required
                    ><?php echo e(old('proof_description')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\Users\Ian Derilo\Herd\lostnfound\resources\views/claim_item.blade.php ENDPATH**/ ?>