<x-layout title="My Reports">
        ...
        const reportsData = {
            @foreach ($reports as $report)
                {{ $report->id }}: {
                    ...
                    date_lost: "{{ $report->date_lost ? \Carbon\Carbon::parse($report->date_lost)->format('M d, Y') : '' }}",
                    date_found: "{{ $report->date_found ? \Carbon\Carbon::parse($report->date_found)->format('M d, Y') : '' }}",
                    date_lost_raw: "{{ $report->date_lost ? \Carbon\Carbon::parse($report->date_lost)->format('Y-m-d') : '' }}",
                    date_found_raw: "{{ $report->date_found ? \Carbon\Carbon::parse($report->date_found)->format('Y-m-d') : '' }}",
    ...
    document.getElementById('editForm').action = "{{ url('/reports') }}/" + reportId;
